 ...
 *		Bubble center axis parallel to y axis.
 */
...
// bubble 1
P1 = newp;
Point(P1) = {x0, y0 + DeltaR + r, z0, bubble};
Printf("xc1 = %f",x0+DeltaR+r); 
P2 = newp;
Point(P2) = {x0, y0 + DeltaR + D, z0, bubble}; 
P3 = newp;
Point(P3) = {x0 + r, y0 + DeltaR + r, z0, bubble}; 
P4 = newp;
Point(P4) = {x0, y0 + DeltaR, z0, bubble}; 
P5 = newp;
Point(P5) = {x0 - r, y0 + DeltaR + r, z0, bubble};
...
// bubble 2
P6 = newp;
Point(P6) = {x0, y0 - DeltaR - r, z0, bubble}; 
Printf("xc2 = %f",x0-DeltaR-r); 
P7 = newp;
Point(P7) = {x0, y0 - DeltaR, z0, bubble}; 
P8 = newp;
Point(P8) = {x0 + r , y0 - DeltaR - r, z0, bubble}; 
P9 = newp;
Point(P9) = {x0, y0 - DeltaR - D, z0, bubble}; 
P10 = newp;
Point(P10) = {x0 - r, y0 - DeltaR - r, z0, bubble};
