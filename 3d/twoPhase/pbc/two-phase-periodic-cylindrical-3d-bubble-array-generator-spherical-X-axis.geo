...
// Points x = xMin
p10 = newp;
Point(p10) = {xa,yMin + Dr,z0,wc};
p11 = newp;
Point(p11) = {xa,yMin,z0 + Dr,wc};
p12 = newp;
Point(p12) = {xa,yMin - Dr,z0,wc};
p13 = newp;
Point(p13) = {xa,yMin,z0 - Dr,wc};

// Points x = xMax
p15 = newp;
Point(p15) = {xb,yMin + Dr,z0,wc};
p16 = newp;
Point(p16) = {xb,yMin,z0 + Dr,wc};
p17 = newp;
Point(p17) = {xb,yMin - Dr,z0,wc};
p18 = newp;
Point(p18) = {xb,yMin,z0 - Dr,wc};

// centers
ppp1 = newp;
Point(ppp1) = {xa,yMin,zMin,wc};
ppp2 = newp;
Point(ppp2) = {xb,yMin,zMin,wc};
...
//Physical Surface("wallOutflow") = {s1,s2};
